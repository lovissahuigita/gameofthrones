...
public class ControlPanel extends JPanel {
    private JButton stark, baratheon, lannister, tully, targaryan, ophiophagus;
    ...
    public ControlPanel() {
        ...
        ophiophagus = new JButton("Ophiophagus");
        ophiophagus.addActionListener(new ButtonListener("Ophiophagus"));
        add(ophiophagus); //ask
